...
import 'package:realstateapp/features/Reals/presentation/view/reals_view.dart';
...
abstract class AppRouter {
  ...
  static const krealsscreen = '/realsscreen';
  static final router = GoRouter(
    routes: [
      ...
      GoRoute(
        path: krealsscreen,
        builder: (context, state) => const RealsView(),
      ),
    ],
  );
}
